<template>
	<view>
		...
		<view class="pl-3 py-2 main-bg-color d-flex a-center j-sb detail-priceBox text-white">
			<view style="width: 85%;">
				<view class="d-flex a-center">
					...
					<view class="VipPrice font-30 font-weight"><image class="arrow" src="../../static/images/details-icon.png" mode=""></image>￥69</view>
				</view>
		...
		<view class="mx-3 py-3">
			<view class="font-32 font-weight pb-2">形象美奇异果洁净嫩滑洁面补水保湿洗面奶护肤品水果去角质洗面奶</view>
		...
		<view class="mx-3 py-3">
			<view class="d-flex j-sb a-center" @click="spaceShow">
				<view class="d-flex a-center">
					...
					<view class="d-flex a-center flex-wrap" style="width: 466rpx;"><view class="mr-1">水动力三部曲套装</view></view>
				</view>
					...
					<view class="detail_pjLis">
						<view class="item" v-for="(item,index) in messageData" :key="index">
							...
							<view class="picLis d-flex a-start flex-wrap">
								<view class="pic"><image src="../../static/images/to-the-pointl-img.png" mode=""></image></view>
								<view class="pic"><image src="../../static/images/to-the-pointl-img.png" mode=""></image></view>
								<view class="pic"><image src="../../static/images/to-the-pointl-img.png" mode=""></image></view>
							</view>
						</view>
			...
			<view class="d-flex">
				...
				<view class="infor">
					<view class="d-flex a-center mt-5 pt-2 mb-3">
						<view class="price font-40 font-weight mr-2">88</view>
						<view class="font-24">会员</view>
